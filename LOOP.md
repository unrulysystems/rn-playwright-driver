...
units:
  ...
  - id: U10
    ...
    state: pending
decisions:
  - { date: 2026-09-04, call: The Metro helper and the native-module plugin ship in the driver package as ./metro and app.plugin.js., status: provisional }
  - { date: 2026-09-04, call: The dedicated iOS simulator for this campaign is named rnpd-clean-seam; the Android target is the Pixel_7_API_35 AVD booted as emulator-5554., status: provisional }
blockers: []
boundary:
  - publish
  - npm-release
